...
\begin{center}\includegraphics[width=1.5\linewidth]{C:/Users/mdelacre/Documents/Github project/thesis/Chapitre 4/title} \end{center}

\begin{center}\includegraphics[width=1.5\linewidth]{C:/Users/mdelacre/Documents/Github project/thesis/Chapitre 4/authornote} \end{center}
...
\begin{figure}
\includegraphics[width=400px]{chp4_format-Rmd_files/figure-latex/BIAS-1} \caption{Sampling distribution for a positively biased (left), an unbiased (center) and a negatively biased estimator (right)}\label{fig:BIAS}
\end{figure}

As we can see in Tables 2 and 3 the bias is directly related to the population effect size. The larger the population effect size, the larger the bias. It is therefore also interesting to examine the \emph{relative bias}, defined as the ratio between the bias and the population effect size :
\begin{equation} 
