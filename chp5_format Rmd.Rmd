...
```{r "TOSTSGPV1", fig.align='center', fig.cap="Comparison of $p$-values from TOST (black line) and SGPV (grey line) across a range of observed sample means ($x$-axis) tested against a mean of 145 in a one-sample $t$-test with a sample size of 30 and a standard deviation of 2, illustrating that when the TOST $p$-value = 0.5, the SGPV = 0.5, when the TOST $p$-value is 0.975, 1-SGPV = 1, and when the TOST $p$-value = 0.025, 1-SGPV = 0.",echo=FALSE,out.height="100%"}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV1.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV2.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV3.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV4.png")
```
...
```{r "TOSTSGPV5", fig.align='center', fig.cap="The relationship between $p$-values from the TOST procedure and the SGPV for the same scenario as in Figure 12.",echo=FALSE,out.height="94%"}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV5.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV6.png")
```
...
```{r "TOSTSGPV7", fig.align='center', fig.cap="The relationship between $p$-values from the TOST procedure and the SGPV for the same scenario as in Figure 17.",echo=FALSE,out.height="94%"}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV7.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV8.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV9.png")
```
...
```{r "TOSTSGPV10", fig.align='center', fig.cap="The relationship between $p$-values from the TOST procedure and the SGPV for the same scenario as in Figure 20.",echo=FALSE,out.height="94%"}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV10.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV11.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV12.png")
```
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 5/TOSTSGPV13.png")
```
