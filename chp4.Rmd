...
```{r "chp4authors", fig.align='center', fig.cap=NULL,echo=FALSE,out.width="150%"}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 4/Capture d’écran 2021-07-13 101115.png
")
```
**Note**: cet article n'a pas encore été accepté pour publication. Nous planifions de tenter une nouvelle soumission en septembre, après avoir inclus une série de modification suggérées par Geoff Cumming, conformément aux échanges reportés dans l'annexe B.
