...
header-includes:
  ...
  - \usepackage{sectsty}
---
# Chapitre 4: utiliser le $\bf \emph g^*$ de Hedges basé sur l'écart-type non poolé
...
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 4/title.png
")
```

```{r "chp4authornote", fig.align='center', fig.cap=NULL,echo=FALSE,out.width="150%"}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/thesis/Chapitre 4/authornote.png
")
```
**Commentaire**: l'article présenté ci-dessous n'a pas encore été accepté pour publication. Nous tenterons prochainement une nouvelle soumission, après avoir inclus une série de modifications suggérées par Geoff Cumming, conformément aux échanges reportés dans l'annexe C (pour l'instant, la seule modification prise en compte est le conseil de supprimer tous les indices "$_s$" associés aux mesure de taille d'effet).
...
#### Shieh's $\bm{d}$
@kulinskaya_confidence_2007 were the first to recommend the use of a standardizer that takes the sample sizes allocation ratios into account, in addition to the variance of both samples. @shieh_confidence_2013, following @kulinskaya_confidence_2007, proposed a modification of the exact *SD* of the sample mean difference: 
\begin{equation*} 
...
*Note.* Fisher's skewness ($G_1$) and kurtosis ($G_2$) are presented in Table 4. The 252 combinations where both $G_1$ and $G_2$ equal 0 correspond to the normal case. 
...
# G1=0; G2=0
output_normal <- read.table("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Data summary/Unbiased estimators/G1=0,G2=0_unbiasedest_properties.txt",sep=";",dec=",")
...
# G1=0; G2 = 95.75
output_heavytails <- read.table("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Data summary/Unbiased estimators/G1=0,G2=95.75_unbiasedest_properties.txt",sep=";",dec=",")
output_heavytails[output_heavytails=="-Inf"|output_heavytails=="Inf"]=NA # max(output_heavytails$relbias_Hedge,na.rm=TRUE)
# G1=-2.08; G2 = 95.75
output_leftskewed <- read.table("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Data summary/Unbiased estimators/G1=2.08,G2=95.75_unbiasedest_properties.txt",sep=";",dec=",")
output_leftskewed[output_leftskewed=="-Inf"|output_leftskewed=="Inf"]=NA # max(output_leftskewed$relbias_Hedge,na.rm=TRUE)
# G1=6.32; G2 = 95.75
output_rightskewed <- read.table("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Data summary/Unbiased estimators/G1=6.32,G2=95.75_unbiasedest_properties.txt",sep=";",dec=",")
...
```{r "idHombal", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are equal across groups (condition a)",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Hom_bal.png")
```

```{r "idHomunbal",echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances are equal across groups and sample sizes are unequal (condition b)",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Hom_unbal.png")
```
...
```{r "idHetbal1", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances are unequal across groups and sample sizes are equal (condition c), as a function of sample sizes",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Het_bal_N.png")
```

```{r "idHetbal2", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances are unequal across groups and sample sizes are equal (condition c) as a function of the $SD$-ratio (when $n_1=n_2=20$)",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Het_bal_sd.png")
```
\newpage
...
```{r "idHetunbal1", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), and $\\sigma_1$ is 10 times larger than $\\sigma_2$",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Het_firstlarger_SDR10.png")
```

```{r "idHetunbal2", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), and $\\sigma_2$ is 10 times larger than $\\sigma_1$",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Het_firstsmaller_SDR10.png")
```

```{r "idHetunbal3", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), and $\\sigma_1$ is twice larger than $\\sigma_2$",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Het_firstlarger_SDR2.png")
```

```{r "idHetunbal4", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), and $\\sigma_2$ is twice larger than $\\sigma_1$",fig.show='hold',fig.align='center'}
knitr::include_graphics("C:/Users/Admin/Documents/Github projects/Effect-sizes/Scripts outputs/Quality of ES measures/Graphs/Unbiased estimators/Combined Figures_relative quality/Het_firstsmaller_SDR2.png")
```
\newpage
