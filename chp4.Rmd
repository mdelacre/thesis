...
")
```
**Commentaire**: l'article présenté ci-dessous n'a pas encore été accepté pour publication. Nous tenterons prochainement une nouvelle soumission, après avoir inclus une série de modifications suggérées par Geoff Cumming, conformément aux échanges reportés dans l'annexe B.
...
```{r "idHetbal1", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances are unequal across groups and sample sizes are equal (condition c), as a function of $n$-ratio",fig.show='hold',fig.align='center'}
...
```{r "idHetunbal1", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), $\\frac{\\sigma_1}{\\sigma_2}=10$ and $\\sigma_1>\\sigma_2$",fig.show='hold',fig.align='center'}
...
```{r "idHetunbal2", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), $\\frac{\\sigma_1}{\\sigma_2}=10$ and $\\sigma_1<\\sigma_2$",fig.show='hold',fig.align='center'}
...
```{r "idHetunbal3", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), $\\frac{\\sigma_1}{\\sigma_2}=2$ and $\\sigma_1>\\sigma_2$",fig.show='hold',fig.align='center'}
...
```{r "idHetunbal4", echo=FALSE, fig.cap="Bias and efficiency of estimators of standardized mean difference, when variances and sample sizes are unequal across groups (condition d), $\\frac{\\sigma_1}{\\sigma_2}=2$ and $\\sigma_1<\\sigma_2$",fig.show='hold',fig.align='center'}
