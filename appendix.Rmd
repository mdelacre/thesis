...
3) **p.11**: *"We will discuss ~~three~~ \color{blue} two \color{black}different origins of unequal standard deviations across two ~~groups~~ \color{blue}populations \color{black}..."* 

4) **p.14** (partie "simulations") : *"As long as the variances are equal between ~~groups~~ color{blue}populations \color{black}or sample sizes are equal, the distribution of Student’s $p$-values is uniform..."*.

5) **Partout**: toutes les mentions au test de Yuen, pour les raisons expliquées en limites. 
