...
En pièce jointe de cet email, figurait un feedback long et détaillé de notre article. Celui-ci est entièrement retranscris juste après le mail. Le texte en bleu qui est inséré dans ce feedback correspond aux réponses que nous lui avons fournies. 
...
**Why Hedges’ $\bm{g_s^*}$ based on the non-pooled standard deviation should be reported with Welch’s $\bm{t}$-test**
...
\color{black} p. 28, l. 422: “parameters that we cannot control…”. You include the $n$-ratio, which is true if, for example, we are meta-analysing past research. But in many cases a researcher chooses sample sizes, and your investigations are likely to lead to useful advice about choice of sample sizes.
