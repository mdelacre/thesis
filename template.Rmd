...
```{r intro, child = 'introduction_format Rmd_bib.Rmd'}
```
...
```{r chp2, child = 'chp2_format Rmd_bib.Rmd'}
```
\newpage
\begingroup
\parindent 0pt
...
```{r chp3, child = 'chp3_format Rmd_bib.Rmd'}
```

\newpage

```{r chp4, child = 'chp4_format Rmd_bib.Rmd'}
```
...
```{r chp5, child = 'chp5_format Rmd_bib.Rmd'}
```
...
\theendnotes
\newpage
```{r conclusion, child = 'conclusion_format Rmd_bib.Rmd'}
```
\begingroup
\parindent 0pt
\renewcommand\notesname{{\normalsize Notes de fin de chapitre}}
