...
```{r "schuirman", fig.align='center', fig.cap="Région d'équivalence pour l'approche de la puissance, pour l'exemple où $|\\theta$|=20, n = 50 et $\\alpha=.05$",echo=FALSE,out.width="96%"}
