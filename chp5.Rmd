...
Avec les tests d'équivalence, il n'est pas possible de démontrer qu'un effet vaille exactement 0 [@meyners_equivalence_2012]. Il est par contre possible de montrer que l'effet observé est suffisamment petit pour être jugé non pertinent. Le point de départ des tests d'équivalence est de définir $\Delta_L$ et $\Delta_U$, les limites inférieures et supérieures de la zone d'équivalence, cette dernière contenant l'ensemble des valeurs jugées trop petites pour être susceptibles de nous intéresser. Les limites peuvent être exprimées soit dans l'unité des données brutes, soit en terme standardisé. Il existe plusieurs stratégies pour les définir, comme nous y reviendrons ultérieurement.
