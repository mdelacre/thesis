...
```{r "equiv1", fig.align = "center", fig.cap= "Différence de moyennes ($\\bar{X_1}-\\bar{X_2}$), distribution d'échantillonnage et IC à $1-2\\alpha\\%$ autour de la différence de moyennes ($\\bar{X_1}-\\bar{X_2}$) pour 4 scénarios distincts.", echo=FALSE, dpi=600, fig.width=5, fig.height=4}
plot(NA, 
     ylim = c(0, 1), 
     xlim = c(-3, 4),
     yaxt = "n",
