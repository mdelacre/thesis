...
Donner l'exemple de Levine et al (2007) sur les jeux vidéos violents. Il se repose sur le conseil de Murphy & Myors (1999) pour décider de considérer la corrélation moyenne de méta-analyse. Ceci dit, ils traitent le problème en unilatéral (pas comme le suggérait Daniel, et c'est plus logique je trouve). Si je veux le faire en bilatéral, il pourrait être utile de suggérer de considérer des percentiles de la distribution des r de la méta analyse (par exemple 5ème et 95eme percentile? demander son avis à CHristophe, mais c'est ce que suggérait Yzerbit).
