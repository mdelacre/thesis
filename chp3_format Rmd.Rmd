...
2) When variances are equal between groups and distributions are not normal, the *W*-test is a little less robust than both the *F*-test and the *F\**-test, but departures from the nominal 5% Type I error rate never exceed the liberal criterion of @bradley_robustness_1978.
