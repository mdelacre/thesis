...
\label{eqn:Fstat}
\end{equation} 
where $S_{j}^2$, $\bar{X_{j}}$ and $n_{j}$ are respectively the variance, mean and size of the $j^{th}$ sample ($j= 1,...,k$), $N=\sum_{j=1}^k n_j$,  and $\bar{X_{..}}$ is overall mean. The degrees of freedom in the numerator and in the denominator of the *F*-test are computed as follows :  
\begin{equation*} 
df_n=k-1
\label{eqn:FnumDF}
\end{equation*} 
...
\label{eqn:BFstat}
\end{equation} 
where $X_j$ and $S_j^2$ are respectively the mean and variance of the $j^{th}$ sample ($j= 1,...k$), and $\bar{X_{..}}$ is the overall mean. As it can be seen in equation \ref{eqn:BFstat}, the numerator of the *F*\* statistic is equal to the sum of squares between groups (which is equal to the numerator of the *F* statistic when one compares two groups). In the denominator, each sample variance is weighted by 1 minus the relative frequency of each sample. This adjustment implies that the variance associated with the smallest sample is given more weight compared to the *F*-test. As a result, when the larger variance is associated with the larger sample size, *F*\* is larger than *F*, because the denominator decreases, leading to more significant findings compared to the *F*-test. On the other hand, when the larger variance is associated with the smaller sample size, *F*\* is smaller than *F*, because the denominator increases, leading to fewer significant findings compared to the *F*-test. The degrees of freedom in the numerator and in the denominator of *F*\*-test are computed as follows (with the same principle as the denominator computation of the *F\** statistic) :
\begin{equation*} 
df_n= k-1
\label{eqn:BFnumDF}
\end{equation*} 
...
\label{eqn:BFdenomDF}
\end{equation*} 
Equation \ref{eqn:Wstat} provides the computation of the Welch's statistic ($W$). In the numerator of the *W* statistic, the squared deviation between sample means and the general mean are weighted by $\frac{n_j}{S_j^2}$ instead of $n_j$ [@Brown_and_Forsythe_1974]. As a consequence, for equal sample sizes, the group with the highest variance will have smaller weight [@Liu_2015]. 
\begin{equation} 
...
\label{eqn:Wstat}
\end{equation} 
where $w_j=\frac{n_j}{S_j^2}$, $w=\sum_{j=1}^kw_j$ and $\bar{X'}=\frac{\sum_{j=1}^k(w_j\bar{X_j})}{w}$. The degrees of freedom of the *W*-test are approximated as follows :
\begin{equation*} 
df_n= k-1
\label{eqn:WnumDF}
\end{equation*} 
...
```{r "Fig5", echo=FALSE, fig.cap="Type I error rate of the $F$-test, $W$-test and $F^*$-test when $SDs$ and sample sizes are equal across groups (cell a in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig6", echo=FALSE, fig.cap="Type I error rate of the $F$-test, $W$-test and $F^*$-test when $SDs$ are equal across groups and sample sizes are unequal (cells b and c in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig7", echo=FALSE, fig.cap="Type I error rate of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups and sample sizes are equal (cells d and g in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig8", echo=FALSE, fig.cap="Type I error rate of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups, and there is a positive correlation between sample sizes and $SDs$ (cells e and i in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig9", echo=FALSE, fig.cap="Type I error rate of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups, and there is a negative correlation between sample sizes and $SDs$ (cells f and h in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig10", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ and sample sizes are equal across groups (cell a in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig11", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ are equal across groups, and there is a positive correlation between sample sizes and means (cell b in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig12", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ are equal across groups, and there is a negative correlation between sample sizes and means (cell c in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig13", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups, there is a positive correlation between $SDs$ and means, and sample sizes are equal (cell d in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig14", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when there $SDs$ are unequal across groups, there is a negative correlation between $SDs$ and means, and sample sizes are equal (cell g in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig15", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups, there is a negative correlation betwen sample sizes and $SDs$, and a positive correlation between $SDs$ and means (cell f in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig16", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups, there is a negative correlation betwen sample sizes and $SDs$, and a negative correlation between $SDs$ and means (cell h in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig17", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups, there is a positive correlation betwen sample sizes and $SDs$, and a positive correlation between $SDs$ and means (cell e  in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
...
```{r "Fig18", echo=FALSE, fig.cap="Power and consistency of the $F$-test, $W$-test and $F^*$-test when $SDs$ are unequal across groups, there is a positive correlation betwen sample sizes and $SDs$, and a negative correlation between $SDs$ and means (cell i  in Table 1)",fig.show='hold',fig.align='center',out.width="100%"}
